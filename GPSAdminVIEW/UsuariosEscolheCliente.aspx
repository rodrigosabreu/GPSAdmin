<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UsuariosEscolheCliente.aspx.cs" Inherits="GPSAdminVIEW.UsuariosEscolheCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <table align="center" class="auto-style1">          
            ...
            <tr>
                <td colspan="3">
                    <strong>Cadastro de Usuários</strong></td>
            </tr>
            <tr>
                <td colspan="3">
